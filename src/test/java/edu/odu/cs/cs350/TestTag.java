 ...
 */
	...
	Tag myTag = new Tag(typ, pth, ext, URI.create("fakeURI"));
	
	
	@Test
	public final void testDefaultConstructor(){
	assertThat(firstTag.getPath(), is(Paths.get("noAssignedPath")));
	assertThat(firstTag.getType(), is(TagType.STYLE));
	assertThat(firstTag.getExternality(), is(Externality.EXTERNAL));
	}
